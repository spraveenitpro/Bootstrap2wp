         ...
         <div class="page-header">
           <div class="row">    
              ...
              <div class="col-xs-3 prev-next">
                ...
                <?php next_post_link('%link', '<span class="glyphicon glyphicon-chevron-left"></span>' ); ?>
                <a href="<?php bloginfo('url' );?>/portfolio"><span class="glyphicon glyphicon-th"></span></a>
                <?php previous_post_link('%link', '<span class="glyphicon glyphicon-chevron-right"></span>' ); ?>
      ...
      <div class="row">
           ...
           <?php if(have_posts() ) : while(have_posts()) : the_post(); ?>
              ...
              <div class="col-sm-4">
                 ...
                 <?php the_content(); ?>
                 <p><a class= "btn btn-primary" href="<?php the_field('link'); ?>">View Site <span class="glyphicon glyphicon-usd"></span></a></p>
